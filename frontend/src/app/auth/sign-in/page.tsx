  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8 transition-all duration-500">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white transition-all duration-500">Welcome back</h1>
        <p className="mt-2 text-gray-600 dark:text-gray-400 transition-all duration-700 delay-100">Sign in to your account</p>
      </div>
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="text-center text-sm text-gray-600 dark:text-gray-400 transition-all duration-1000 delay-300">
          <p>
            ...
            <a href="/auth/sign-up" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 transition-all duration-300">
              Sign up
            </a>
          </p>
        </div>
